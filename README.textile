...
* Ruby 1.9.2
** Gosu gem 0.7.27 ("Dependencies":https://github.com/jlnr/gosu/wiki/Getting-Started-on-Linux)
** Chingu gem 0.9rc4
** Chipmunk gem 5.3.4.0
** Fidgit gem 0.0.5alpha
** Texplay gem 0.3.5

h4. Using Bundler to install gems (recommended)

In the game's main directory (with _Gemfile_ in it), use Bundler to automatically install the correct gem versions:
