...
* Ruby 1.9.2
** Gosu gem 0.7.27 (Dependencies: "Linux":https://github.com/jlnr/gosu/wiki/Getting-Started-on-Linux)
** Chingu gem 0.9rc4
** Chipmunk gem 5.3.4.0 (NOTE: Dependencies for the current version of Chipmunk are not known at the moment for Linux)
** Fidgit gem 0.0.5alpha
** Texplay gem 0.3.5

h4. Using Bundler to install gems (recommended)
...
h4. Manual installation of gems
