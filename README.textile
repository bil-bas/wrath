...
* Player 2 controls: Arrow keys + RightControl
...
Wrath creates a log every time it runs. If you have problems or crashes, it will help to include a copy of the log in your report :)
